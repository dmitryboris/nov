...
label beginning:
    scene house
    narrator "Мы видим красивый и уютный дом, где живет подросток Максим с своей мамой Еленой и \
...
label studying:
    ...
    на учебу и тренировки. Максим хорошо сдает экзамены и поступает на обучение в МЧС."

    nvl_narrator "Максим поступает в пожарную академию"

    nvl_narrator "Максим погружается в интенсивные тренировки и учебу. Он учится разбираться с огнем, \
    пользоваться экипировкой и работать в команде. Максим проходит испытания и тренировки со своими товарищами по \
    академии, становится все сильнее и опытнее."
    ...
    max "Ты прав, Миша. Нам доверена невероятная сила и возможность защищать себя и других людей. Не можем допустить, чтобы она попала в неправильные руки."
    misha "Согласен. Максим, ты с каждым днем становишься все сильнее и ловчее."
    max "Спасибо, Миша. Ты меня всегда поддерживал и наставлял на верный путь. Без тебя я бы не смог пройти через все эти испытания."
    misha "Помни, Максим, мы — команда. Вместе мы сможем преодолеть любые трудности и добиться успеха."
...
label epilog:
    ...
    dad "Ты преодолел настоящие испытания и по-настоящему изменил жизни многих людей в этом городе. Весь город \
    говорит о тебе и думает о тебе как о герое. Ты - моя главная гордость."
    max "Спасибо, папа. Я никогда не считал себя героем, я просто делал то, что казалось правильным. Но видеть, как мои действия влияют \
      на других, как я могу приносить радость и надежду в жизнь людей, - это непередаваемое чувство."
