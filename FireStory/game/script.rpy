...
label studying:
    ...
    nvl_narrator "Он погружается в интенсивные тренировки и учебу. Он учится разбираться с огнем, \
    пользоваться экипировкой и работать в команде."
    nvl_narrator "Максим проходит испытания и тренировки со своими товарищами по академии, становится все сильнее и опытнее."
